      ...
      <template v-for="item of items">
        <li
          ...
          :style="{
            ...
            '--extraDisplay': item.style.extraAlwaysVisible
              ? 'inline-block'
              : 'none',
          ...
          @dragend="dragEndEvent(item, $event)"
        ...
        >
          <span
            class="vue-tree-switcher-wrapper"
            v-if="item.style.showSwitcher"
            @click.stop="toggleDirectoryState(item)"
          >
            <slot name="switcher" v-bind:node="item">
              <svg
                class="vue-tree-switcher-icon vue-tree-switcher-expanded"
                viewBox="-7 -3 46 46"
                fill="currentColor"
                aria-hidden="true"
                v-if="item.directoryState === 'expanded'"
              >
                <path d="M30 10 L16 26 2 10 Z" />
              </svg>
              <svg
                class="vue-tree-switcher-icon vue-tree-switcher-collapsed"
                viewBox="-7 -3 46 46"
                fill="currentColor"
                aria-hidden="true"
                v-else-if="item.directoryState === 'collapsed'"
              >
                <path d="M10 30 L26 16 10 2 Z" />
              </svg>
              <svg
                class="vue-tree-switcher-icon vue-tree-switcher-loading"
                viewBox="0 0 32 32"
                fill="none"
                stroke="currentcolor"
                ...
                stroke-width="2"
                v-else-if="item.directoryState === 'loading'"
              >
                <path
          ...
          <span
            class="vue-tree-checkbox-wrapper"
            v-if="item.checkbox.show"
            ...
            <slot name="checkbox" v-bind:node="item">
              <span
                :class="{
                  ...
                  'vue-tree-checkbox-checked':
                    item.checkbox.state === 'checked',
                  'vue-tree-checkbox-unchecked':
                    item.checkbox.state === 'unchecked',
                  'vue-tree-checkbox-undetermined':
                    item.checkbox.state === 'undetermined',
          ...
          <span
            class="vue-tree-icon-and-title"
            :ref="'icon-and-title-' + item.id"
          >
            <span class="vue-tree-icon-wrapper" v-if="item.style.showIcon">
              <slot name="icon" v-bind:node="item">
                <svg
                  ...
                  v-if="
                    item.hasChild &&
                    (item.directoryState === 'collapsed' ||
                      item.directoryState === 'expanded')
                  "
                >
            ...
            <span class="vue-tree-title-wrapper" :ref="'title-' + item.id">
              <template v-if="item.__.isEditing">
                <slot name="input" v-bind:node="item">
                  ...
                  <span
                    ...
                    class="
                      vue-tree-title
                      vue-tree-title-editing
                      vue-tree-title-hidden
                    "
                    >{{ item.title }}</span
                  >
                </slot>
              ...
              <template v-else>
                <slot name="title" v-bind:node="item">
                  <span class="vue-tree-title" :title="item.__.titleTip">{{
                    item.title
                  }}</span>
                </slot>
              </template>
          ...
          <span class="vue-tree-extra-wrapper">
            <slot name="extra" v-bind:node="item"> </slot>
          </span>
          <div
          ...
          >
            <slot name="contextmenu" v-bind:node="item"> </slot>
          </div>
          <div
            class="vue-tree-drag-arrow-wrapper"
            v-if="item.__.dragOverArea !== null"
          >
          ...
          <template v-if="useDragImage">
          <div
            v-if="
              dragAndDrop.dragNode === item &&
              (enableDragNodeOut === true ||
                dragAndDrop.status === DND_STATUS.INTERNAL) &&
              dragAndDrop.clientX !== null
            "
          ...
          >
            <slot name="drag-image" v-bind:node="item" v-bind:dnd="dragAndDrop">
              <span class="vue-tree-drag-image">{{
...
export default {
  ...
  data() {
    return {
      ...
      DND_STATUS: {
        // enum values of dragAndDrop.status
  ...
  methods: {
        ...
        if (node.hasChild) {
          ...
          for (let i = node.children.length - 1; i >= 0; i--) {
            ...
            this.setAttr(
              ...
              "__",
              "depth",
              this.getAttr(node, "__", "depth") + 1
            );
            this.setAttr(child, "__", "parent", node);
            this.setAttr(child, "__", "path", [
              ...this.getAttr(node, "__", "path"),
              node,
            ]);
        ...
        function (node, i) {
          ...
          if (titleMaxWidth[0] === "-") {
            if (titleMaxWidth[titleMaxWidth.length - 1] === "%") {
              titleMaxWidth =
                " - " +
                (-1 * parseFloat(titleMaxWidth)) / 100.0 +
                " * var(--treeWidth)";
            }
            titleMaxWidth =
              "calc(var(--treeWidth) - 1em - var(--switcherMarginRight) - 2px - 1em - var(--iconMarginRight) " +
              titleMaxWidth +
              " - (" +
              fullIndentVal +
              "))";
            ...
            titleMaxWidth =
              "calc(" +
              parseFloat(titleMaxWidth) / 100.0 +
              " * var(--treeWidth))";
          }
          ...
          this.setAttr(
            ...
            "checkbox",
            "show",
            this.getAttr(node, "checkbox", "show")
          );
          this.setAttr(
            node,
            "checkbox",
            "disable",
            this.getAttr(node, "checkbox", "disable")
          );
          this.setAttr(
            node,
            "checkbox",
            "state",
            this.getAttr(node, "checkbox", "state")
          );
          ...
          this.setAttr(
            ...
            "style",
            "height",
            this.getAttr(node, "style", "height")
          );
          this.setAttr(
            node,
            "style",
            "indent",
            this.getAttr(node, "style", "indent")
          );
          this.setAttr(
            node,
            "style",
            "fontSize",
            this.getAttr(node, "style", "fontSize")
          );
          this.setAttr(
            node,
            "style",
            "bgColor",
            this.getAttr(node, "style", "bgColor")
          );
          this.setAttr(
            node,
            "style",
            "hoverBgColor",
            this.getAttr(node, "style", "hoverBgColor")
          );
          this.setAttr(
            node,
            "style",
            "selectedBgColor",
            this.getAttr(node, "style", "selectedBgColor")
          );
          this.setAttr(
            node,
            "style",
            "dragOverBgColor",
            this.getAttr(node, "style", "dragOverBgColor")
          );
          this.setAttr(
            node,
            "style",
            "switcherMarginRight",
            this.getAttr(node, "style", "switcherMarginRight")
          );
          this.setAttr(
            node,
            "style",
            "iconMarginRight",
            this.getAttr(node, "style", "iconMarginRight")
          );
          this.setAttr(
            node,
            "style",
            "checkboxMarginRight",
            this.getAttr(node, "style", "checkboxMarginRight")
          );
          this.setAttr(
            node,
            "style",
            "extraFloatRight",
            this.getAttr(node, "style", "extraFloatRight")
          );
          this.setAttr(
            node,
            "style",
            "extraAlwaysVisible",
            this.getAttr(node, "style", "extraAlwaysVisible")
          );
          this.setAttr(
            node,
            "style",
            "titleMaxWidth",
            this.getAttr(node, "style", "titleMaxWidth")
          );
          this.setAttr(
            node,
            "style",
            "titleOverflow",
            this.getAttr(node, "style", "titleOverflow")
          );
          this.setAttr(
            node,
            "style",
            "marginTop",
            this.getAttr(node, "style", "marginTop")
          );
          this.setAttr(
            node,
            "style",
            "marginBottom",
            this.getAttr(node, "style", "marginBottom")
          );
          this.setAttr(
            node,
            "style",
            "showSwitcher",
            this.getAttr(node, "style", "showSwitcher")
          );
          this.setAttr(
            node,
            "style",
            "showIcon",
            this.getAttr(node, "style", "showIcon")
          );
          ...
          this.setAttr(
            ...
            "__",
            "isEditing",
            this.getAttr(node, "__", "isEditing")
          );
          this.setAttr(
            node,
            "__",
            "isSearchResult",
            this.getAttr(node, "__", "isSearchResult")
          );
          this.setAttr(
            node,
            "__",
            "isDroppable",
            this.getAttr(node, "__", "isDroppable")
          );
          this.setAttr(
            node,
            "__",
            "dragOverArea",
            this.getAttr(node, "__", "dragOverArea")
          );
          this.setAttr(
            node,
            "__",
            "height",
            this.getAttr(node, "__", "height")
          );
          this.setAttr(
            node,
            "__",
            "mousex",
            this.getAttr(node, "__", "mousex")
          );
          this.setAttr(
            node,
            "__",
            "mousey",
            this.getAttr(node, "__", "mousey")
          );
          this.setAttr(
            node,
            "__",
            "titleTip",
            this.getAttr(node, "__", "titleTip")
          );
    ...
    reload() {
      (this.nodes = JSON.parse(JSON.stringify(this.tree))), this.refresh();
    },
    refresh() {
    ...
    getAttr() {
      ...
      if (arguments.length === 3) {
        ...
        if (
          this.defaultAttrs.hasOwnProperty(key) &&
          this.defaultAttrs[key].hasOwnProperty(subKey)
        ) {
          return this.defaultAttrs[key][subKey];
        }

        if (
          this.spareDefaultAttrs.hasOwnProperty(key) &&
          this.spareDefaultAttrs[key].hasOwnProperty(subKey)
        ) {
    ...
    getDirectoryState(node) {
      ...
      if (directoryState === null) {
        directoryState =
          this.defaultAttrs.hasOwnProperty("directoryState") &&
          this.defaultAttrs.directoryState !== null
    ...
    generateId() {
      ...
      return "vue-tree-node-" + this.autoIdCounter;
    },
    edit(node) {
    ...
    getTitleElement(node) {
      ...
      if (this.$refs.hasOwnProperty(refId)) {
        return this.$refs[refId].children[0];
      }
    ...
    mouseenterEvent(node) {
      let titleElement = this.getTitleElement(node);
      let tip =
        titleElement.offsetWidth < titleElement.scrollWidth ? node.title : "";
    ...
    getHiddenTitleWidth(node) {
      ...
      if (this.$refs.hasOwnProperty(hiddenRefId)) {
        let hiddenTitle = this.$refs[hiddenRefId];
    ...
    select(node) {
      if (
        typeof this.fnBeforeSelect === "function" &&
        this.fnBeforeSelect(node) === false
      ) {
        return;
      }
    ...
    contextMenuEvent(node, event) {
      if (
        typeof this.fnBeforeContextMenu === "function" &&
        this.fnBeforeContextMenu(node, event) === false
      ) {
        return;
      }
    ...
    treeBlurEvent(e) {
      ...
      if (
        ...
        !this.getElement(this.contextMenu.node).contains(relatedTarget)
      ) {
        this.hideContextMenuOnDisplay();
      }
    },
    create(node, parentNode, pos) {
      if (parentNode === null) {
        ...
        this.setAttr(
          parentNode,
          "directoryState",
          this.getDirectoryState(parentNode)
        );
      }
    ...
    move(node, toParent, toPos) {
      ...
      if (fromParent === null) {
        ...
        this.setAttr(
          fromParent,
          "directoryState",
          this.getDirectoryState(fromParent)
        );
      }
      ...
      if (toParent === null) {
        ...
        this.setAttr(
          toParent,
          "directoryState",
          this.getDirectoryState(toParent)
        );
      }
    ...
    expand(node) {
      ...
      if (
        ...
        this.fnBeforeExpand(node) === false
      ) {
        return;
      }
    ...
    collapse(node) {
      ...
      if (
        typeof this.fnBeforeCollapse === "function" &&
        this.fnBeforeCollapse(node) === false
      ) {
        return;
      }
    ...
    defaultIsDroppable() {
      ...
      if (
        this.dragAndDrop.dragNode.__.parent ===
        this.dragAndDrop.overNode.__.parent
      ) {
    ...
    dragStartEvent(node, event) {
      if (
        typeof this.fnBeforeDrag === "function" &&
        this.fnBeforeDrag(node) === false
      ) {
        event.preventDefault();
        return;
      }
      ...
      this.useDragImage && event.dataTransfer.setDragImage(this.emptyImage, 0, 0);
      event.dataTransfer.dropEffect = "move";
      // event.dataTransfer.effectAllowed = "all";
      event.dataTransfer.effectAllowed = "copyMove"; // allow to change cursor style on dragging
    ...
    dragOverEvent(node, event) {
      if (
        ...
        this.enableDropExternalElement === false
      ) {
        return;
      }
    ...
    dragEndEvent(node, event) {
      ...
      this.$emit("dragend", this.dragAndDrop, event, node);
    },
    moveOnDrop() {
    ...
    dropEvent(event) {
      ...
      if (
        typeof this.fnBeforeDrop === "function" &&
        this.fnBeforeDrop(this.dragAndDrop) === false
      ) {
        return;
      }
    ...
    check(node) {
      ...
      if (
        typeof this.fnBeforeCheck === "function" &&
        this.fnBeforeCheck(node) === false
      ) {
        return;
      }
      ...
      for (let i = gpos; i < this.items.length; i++) {
        ...
        if (
          !this.items[i].hasChild &&
          this.getAttr(this.items[i], "checkbox", "show") === true &&
          this.getAttr(this.items[i], "checkbox", "disable") === false
        ) {
      ...
      let path = this.getAttr(node, "__", "path");
      let top = path.length > 0 ? path[0] : node;
    ...
    uncheck(node) {
      ...
      if (
        typeof this.fnBeforeUncheck === "function" &&
        this.fnBeforeUncheck(node) === false
      ) {
        return;
      }
    ...
    getByCheckboxState(state) {
      ...
      for (let i = 0; i < this.items.length; i++) {
        if (
          this.getAttr(this.items[i], "checkbox", "show") === true &&
          this.getAttr(this.items[i], "checkbox", "state") === state
        ) {
  ...
  mounted() {
    ...
    // polyfill to support drag n drop on mobile and tablet devices
    polyfill({
    ...
    document.body.addEventListener(
      "dragover",
      this.globalDragOverEvent.bind(this)
    );
    ...
    this.treeWidthInterval = setInterval(
      function () {
...
.vue-tree-node.isDragging {
  cursor: grabbing !important;
}
.vue-tree-node {
  cursor: pointer !important;
}
.vue-tree-node-enter-to,
.vue-tree-node-leave-from {
  height: var(--height);
  opacity: 1;
}
...
.vue-tree-node-enter-active,
.vue-tree-node-leave-active {
...
.vue-tree-node.vue-tree-node-selected {
  background-color: var(--selectedBgColor);
}
.vue-tree-node .vue-tree-icon-and-title {
...
.vue-tree-node .vue-tree-title.vue-tree-title-editing {
  display: inline-block;
...
.vue-tree-node .vue-tree-title.vue-tree-title.vue-tree-title-editing input {
  box-sizing: content-box;
}
.vue-tree-node .vue-tree-title.vue-tree-title-editing.vue-tree-title-hidden {
  position: absolute;
  visibility: hidden;
}
.vue-tree-node .vue-tree-switcher-wrapper {
  text-indent: 0;
  vertical-align: middle;
  display: inline-block;
  min-width: 1em;
...
.vue-tree-node .vue-tree-switcher-wrapper .vue-tree-switcher-icon {
  width: 1em;
  height: 1em;
  vertical-align: middle;
}
.vue-tree-node
  ...
  .vue-tree-switcher-icon.vue-tree-switcher-loading {
  animation-name: spin;
...
.vue-tree-node .vue-tree-icon-wrapper {
  margin-right: var(--iconMarginRight);
}
.vue-tree-node .vue-tree-icon-wrapper .vue-tree-icon {
  width: 1em;
  height: 1em;
  vertical-align: middle;
}
.vue-tree-node.vue-tree-node-search-result .vue-tree-title {
  color: brown;
  font-weight: bold;
}
.vue-tree-node .vue-tree-extra-wrapper {
...
.vue-tree-node.vue-tree-not-droppable .vue-tree-not-droppable-sign {
  text-indent: 0;
  position: absolute;
  left: var(--mousex);
...
.vue-tree-node .vue-tree-checkbox-wrapper {
  display: inline-block;
  text-indent: 0;
  margin-right: var(--checkboxMarginRight);
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox {
  display: inline-block;
  width: 1em;
  height: 1em;
...
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-checked:after {
  content: "";
...
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-checked {
  color: white;
...
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-checked.vue-tree-checkbox-disabled {
  border-color: #dcdee2;
...
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-checked.vue-tree-checkbox-disabled:after {
  border-color: #a6a6a6;
}
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-unchecked {
  background-color: white;
}
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-unchecked.vue-tree-checkbox-disabled {
  background-color: #f5f5f5;
}
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-undetermined:after {
  content: "";
  border: 0;
  padding: 0;
  margin: 0;
...
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-undetermined {
  color: white;
  background-color: #2d8cf0;
  border-color: #2d8cf0;
}
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-undetermined.vue-tree-checkbox-disabled {
  border-color: #dcdee2;
  background-color: #f5f5f5;
}
.vue-tree-node
  .vue-tree-checkbox-wrapper
  .vue-tree-checkbox.vue-tree-checkbox-undetermined.vue-tree-checkbox-disabled:after {
  background-color: #a6a6a6;
}
.vue-tree-node .vue-tree-contextmenu-wrapper {
  position: fixed;
  display: block;
  left: var(--mousex);
  top: var(--mousey);
